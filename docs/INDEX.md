...
- [**guides/event-driven.md**](guides/event-driven.md) — Guia de event-driven com Kafka e SQS: `Broker`, `EventRouter`, macros `#[subscriber]`/`#[publisher]`, Lambda ESM, worker standalone, FIFO, AsyncAPI e operações de fila.
